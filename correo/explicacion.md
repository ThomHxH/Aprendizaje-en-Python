...
* **`.replace(" ", ".")`**: Para cambiar espacios por puntos (clave para los emails).
* **`.lower()`**: Para que todo quede en minúsculas.
* **`.strip()`**: Para borrar esos espacios molestos que quedan al principio o al final.
